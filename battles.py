...
class Battle:
    ...
    def fight(self):
        ...
        while self.player.health > 0 and self.enemy.health >0 and self.in_battle:
            ...
            if self.player.health <=0:
                ...
                for gag in self.player.gag_counts: # remove gags
                    self.player.gag_counts[gag]= 0
    ...
    def player_turn(self):
        ...
        while True:
            ...
            for idx, gag_name in enumerate(self.player.inventory, start=1):
                count_str = f" ({self.player.gag_counts.get(gag_name, 0)})"
            ...
            if choice == 0:
                ...
                if random.random() < 0.6:#60% chance to run or stay in battle?
                ...
                chosen_gag_name = self.player.inventory[choice - 1]
                if self.player.gag_counts.get(chosen_gag_name, 0) > 0:
                    self.player.use_gag(self.enemy, chosen_gag_name, self)
                    break
